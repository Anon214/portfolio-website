...
export default function AboutMe(props) {
  const technologies = [
    ["TypeScript", "Next.js", "React", "Tailwind CSS", "Supabase"],
    ["Python", "Java", "C/C#", "Node.js", "JavaScript"],
  ];
  return (
          ...
          <div className="w-full md:w-7/12 space-y-4 sm:text-base text-sm ">
            <div className="font-Header ">
              <span className="text-gray-400 ">
                ...
                Every since then, I loved solving dificult problems and started refining my craft.
              </span>
            </div>
            <div className="font-Header ">
              <span className="text-gray-400 ">
                I am primary interested in Software Development and Machine Learning.
              </span>
            </div>
