      ...
      >
        <div className="flex flex-col space-y-8 justify-center items-center">
          <div className="flex flex-col justify-center items-center space-y-5">
            {/* Github Icon */}
            <IconClickableWithAnimation Icon={GithubIcon} href={"https://github.com/Anon214"} />
            {/* Linkedin icon */}
            <IconClickableWithAnimation Icon={LinkedinIcon} href={"https://www.linkedin.com/in/anonrahman/"} />
          </div>
          ...
          >
            <a href="mailto:arahma27@gmu.edu" target={"_blank"} rel="noreferrer">
              <span className=" font-Header tracking-wider text-gray-400 hover:text-AAsecondary hover:cursor-pointer">
                arahma27<span className="text-AAsecondary">@</span>gmu<span className="text-AAsecondary">.</span>edu
              </span>
            </a>
          </motion.div>
